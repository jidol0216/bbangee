...
def create_presentation():
    ...
    add_diagram_slide(prs, " 군 위병소 자동화 시스템 (ver1)", """
   ...
   음성출력    + 웹 UI 알림             + 웹 UI 경고    발사!
    ...
    # ==================== 슬라이드 4: 프로젝트 소개 ====================
    add_section_slide(prs, "프로젝트 소개", "1")
    ...
    # ==================== 슬라이드 6-12: 개발 히스토리 ====================
    add_section_slide(prs, "개발 히스토리", "3")
    ...
    # ==================== 슬라이드 13-14: 시스템 아키텍처 ====================
    add_section_slide(prs, "시스템 아키텍처", "4")
    
    add_diagram_slide(prs, " 전체 파이프라인", """
    ┌─────────────────────────────────────────────────────────────────────┐
    │                         RealSense D435i                              │
    │                      (RGB 640x480 + Depth)                           │
    └───────────────────────────────┬─────────────────────────────────────┘
    ...
    # ==================== 슬라이드 15-17: 기술 선택 비교 ====================
    add_section_slide(prs, "기술 선택 비교", "5")
    ...
    # ==================== 슬라이드 18-19: 핵심 알고리즘 ====================
    add_section_slide(prs, "핵심 알고리즘", "6")
    ...
    # ==================== 슬라이드: 결과 및 성과 ====================
    add_section_slide(prs, "결과 및 성과", "7")
    ...
    # ==================== 미완성 모듈 & 향후 계획 ====================
    add_section_slide(prs, "미완성 모듈 & 향후 계획", "8")
